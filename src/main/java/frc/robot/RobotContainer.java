...
public class RobotContainer {
  ...
  // porch
  private final IntervalSolenoid julianMech = new IntervalSolenoid(new PCMSolenoid(0), TEMP_DELAY, TEMP_PERIOD,
      TEMP_PERIOD, TEMP_HOLD_DURATION); // porch

  // private final IntervalSolenoid julianMech = new IntervalSolenoid(new
  // MotorControllerSolenoid(0), TEMP_DELAY, TEMP_PERIOD,TEMP_PERIOD,
  // TEMP_HOLD_DURATION); // porch

  // 1st lower
  // private final IntervalSolenoid aidenMech = null;

  // 2nd lower
  // private final IntervalSolenoid ryanMech = new IntervalSolenoid(new
  // MotorControllerSolenoid(0), TEMP_DELAY, TEMP_PERIOD, TEMP_PERIOD,
  // TEMP_HOLD_DURATION);
  ...
  // 1st upper
  // private final IntervalSolenoid shiraMech = new IntervalSolenoid(new
  // MotorControllerSolenoid(0), TEMP_DELAY, TEMP_PERIOD, TEMP_PERIOD,
  // TEMP_HOLD_DURATION));

  // 2nd upper
  // private final IntervalSolenoid oliviaMech = new IntervalSolenoid(new
  // MotorControllerSolenoid(0), TEMP_DELAY, TEMP_PERIOD,TEMP_PERIOD,
  // TEMP_HOLD_DURATION);
