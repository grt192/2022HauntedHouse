...
public class RobotContainer {
    ...
    // LOWER FLOOR
    private final IntervalSolenoid aidenMech = new IntervalSolenoid(new MotorControllerSolenoid(AIDEN_ID), 0, 2, 2, 2);
    private final IntervalSolenoid ryanMech = new IntervalSolenoid(new MotorControllerSolenoid(RYAN_ID), 2, 20, 30, 10);
    private final IntervalSolenoid matthewMech = new IntervalSolenoid(new MotorControllerSolenoid(MATTHEW_ID), 4, 10, 10, 3);

    // UPPER FLOOR
    
    private final IntervalSolenoid shiraMech = new IntervalSolenoid(new MotorControllerSolenoid(SHIRA_ID), 2, 2, 2, 1);
